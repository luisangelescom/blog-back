...
export class ModelDescription {
  ...
  static async getAllPost (postId: number): Promise<PostModel[]> {
  ...
  static async createPost (postId: number, userId: number, description: string): Promise<PostDescriptionModel> {
