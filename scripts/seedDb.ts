...
import PostDescriptionModel from '../src/post/models/PostDescriptionModel'
import PostLikeModel from '../src/post/models/PostLikeModel'
...
(async function seed () {
  ...
  // await PostDescriptionModel.drop()
  await PostDescriptionModel.sync({ force: true })

  // await PostLikeModel.drop()
  await PostLikeModel.sync({ force: true })
